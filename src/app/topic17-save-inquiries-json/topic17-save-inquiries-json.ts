...
@Component({
    selector:'app-topic17-save-inquiries-json',
    templateUrl:'topic17-save-inquiries-json.html',
    styleUrl:'topic17-save-inquiries-json.css'
})
export class Topic17SaveInquiriesJson   {
      loading = false;
  validationError = "";
  successMessage = "";
  serverError = false;
